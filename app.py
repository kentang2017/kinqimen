...
with pan:
    ...
    with st_capture(output2.code):
        if not manual:
            ...
            print("農曆月：{} | 節氣日數差距：{}天\n".format(config.qimen_ju_name_zhirun_raw(ny, nm, nd, nh, nmintue).get("農曆月"),config.qimen_ju_name_zhirun_raw(ny, nm, nd, nh, nmintue).get("距節氣差日數")))
        ...
        if manual:
            ...
            if num == 2:
                ...
                print("農曆月：{} | 節氣日數差距：{}天\n".format(config.qimen_ju_name_zhirun_raw(y,m,d,h,mintue).get("農曆月"),config.qimen_ju_name_zhirun_raw(y,m,d,h,mintue).get("距節氣差日數")))
                print("＼  {}{}  　 │  {}{}　 │  {}{}　 │  　 {}{}　 ／".format(e_to_s.get("巳"),e_to_g.get("巳"),e_to_s.get("午"),e_to_g.get("午"),e_to_s.get("未"),e_to_g.get("未"),e_to_s.get("申"),e_to_g.get("申")))
                print("  ＼────────┴──┬─────┴─────┬──┴────────／")
                print(" 　│　　{}　　　 │　　{}　　　 │　　{}　　　 │".format(god[0], god[1], god[2]))
                print(" 　│　　{}　　{} │　　{}　　{} │　　{}　　{} │".format(door[0], qt[0], door[1], qt[1], door[2], qt[2]))
