...
def pan_sky_minute(year, month, day, hour, minute ):
    ...
    liujia = list("戊己庚辛壬癸")
    orders = [[[0,1,2,3,1,4,5,6,7],[3,0,1,5,0,2,6,7,4],[2,4,7,1,4,6,0,3,5],[1,2,4,0,2,7,3,5,6],[6,5,3,7,5,0,4,2,1],[7,6,5,4,6,3,2,1,0]],[[0,1,2,3,1,4,5,6,7],[1,2,4,0,2,7,3,5,6],[2,4,7,1,4,6,0,3,5],[5,3,0,6,3,1,7,4,2],[6,5,3,7,5,0,4,2,1],[7,6,5,4,6,3,2,1,0]],[[0,1,2,3,1,4,5,6,7],
